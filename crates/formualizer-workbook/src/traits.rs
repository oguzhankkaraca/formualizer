...
pub struct AdapterLoadStats {
    ...
    pub formula_ingest_ns: Option<u64>,
    pub range_dependencies_observed: Option<u64>,
    pub all_unbounded_range_dependencies: Option<u64>,
    pub all_unbounded_range_index_insertions: Option<u64>,
    pub all_unbounded_range_elapsed_ns: Option<u64>,
    pub range_dependency_publication_ns: Option<u64>,
    pub defined_names_observed: Option<u64>,
    pub defined_name_formula_count: Option<u64>,
    pub defined_names_accepted: Option<u64>,
    pub defined_names_skipped: Option<u64>,
    pub defined_name_parse_ns: Option<u64>,
    pub defined_name_dependency_extraction_calls: Option<u64>,
    pub defined_name_dependency_ns: Option<u64>,
    pub defined_name_publication_ns: Option<u64>,
    pub defined_name_pending_resolution_ns: Option<u64>,
    pub defined_name_pending_resolution_links: Option<u64>,
    pub defined_name_symbol_vertex_allocations: Option<u64>,
    pub defined_name_index_insertions: Option<u64>,
    pub defined_name_symbol_revision_bumps: Option<u64>,
    pub defined_name_symbol_revision_updates: Option<u64>,
    pub table_count: Option<u64>,
    pub table_ingest_ns: Option<u64>,
    pub sheet_index_finalization_count: Option<u64>,
    pub sheet_index_finalization_ns: Option<u64>,
    pub load_total_ns: Option<u64>,
}
