...
| `investigation/fossil-excel-calculation` | SCC/compact dependency experiments; no production optimization | [`010`](010-excel-vs-formualizer-fossil-calculation-investigation.md), [`011`](011-scc-termination-and-compact-dependency-experiment.md) |
