...
The UI track is now in progress on `ui/formualizer-canvas`; the Fossil performance investigation and Excel reverse-engineering evidence are recorded in [`009`](009-fossil-performance-investigation.md) and [`010`](010-excel-vs-formualizer-fossil-calculation-investigation.md). The bounded Engine V2 architecture POC is documented in [`docs/engine-v2-poc.md`](../engine-v2-poc.md) and is isolated from production routing.
